...
public class MyApplication4 extends JFrame implements ActionListener{
  ...
  public static void main(String[] args){
    MyApplication4 app = new MyApplication4();
    app.pack();
    app.setVisible(true);
  }
  ...
  class DeleteButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent e) {
      mediator.removeDrawing(mediator.selectedDrawing);
      mediator.repaint();
    }
  }
  ...
  class ShadowButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent e) {
      if(mediator.selectedDrawing.isShadow != true){
        mediator.selectedDrawing.isShadow = true;
      } else {
        mediator.selectedDrawing.isShadow = false;
      }
      mediator.repaint();
    }
  }
